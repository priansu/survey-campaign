...
export const initialState = {
  ...
  content: {
    ...
    thankYou: {
      ...
      subtitle:
        "Your responses have been recorded. We really appreciate the feedback.",
  ...
  styling: {
    ...
    questionTitle: defaultTextStyle({
      fontSize: 19,
      fontWeight: 700,
    }),
    ...
    additionalComment: defaultBoxStyle({
      fontSize: 13,
    }),
